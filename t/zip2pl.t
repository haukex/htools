...
# This code was generated by zip2pl 0.02 from "<<TEMPNAME>>"
...
UEsDBAoAAAAAALB5aE7H9y8ABgAAAAYAAAAHABwAZm9vLnR4dFVUCQADjHiCXIx4glx1eAsAAQTo
AwAABOgDAABQZXJsIQpQSwECHgMKAAAAAACweWhOx/cvAAYAAAAGAAAABwAYAAAAAAABAAAAgIEA
AAAAZm9vLnR4dFVUBQADjHiCXHV4CwABBOgDAAAE6AMAAFBLBQYAAAAAAQABAE0AAABHAAAAAAA=
END
my $out2 = run $ZIP2PL, { stdin=>\$zipf2, fail_on_stderr=>1,
	binmode_stdout=>':raw:encoding(UTF-8)', binmode_stdin=>':raw' };
is $out2, <<'__END_SAMPLE__', 'ZIP read from STDIN';
use warnings;
use strict;
use utf8;
use Archive::Zip 'AZ_OK';
use MIME::Base64 'decode_base64';
my $zip = Archive::Zip->new();
# This code was generated by zip2pl 0.02 from STDIN
$zip->addString(do{utf8::encode(my $x=<<'END');$x},"foo.txt");
Perl!
END
binmode STDOUT;
$zip->writeToFileHandle(\*STDOUT,0) == AZ_OK
